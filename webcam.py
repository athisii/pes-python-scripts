...
import cv2
import math
#print("Message= Above pybase64")
#import pybase64 as base64
import glob
from PIL import Image,ImageEnhance
#import mediapipe1 as mp
...
if head_det == 0:
    ...
    im = Image.fromarray(cv2.cvtColor(face_, cv2.COLOR_BGR2RGB)).convert("RGBA")
